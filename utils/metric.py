...
def get_metrics(golden_lists, predict_lists, label_list):
    sent_num = len(golden_lists)
    golden_full = []
    predict_full = []
    cal_labels = [ele for ele in label_list if ele!="O"]
    ...
    p = metrics.precision_score(golden_full, predict_full, labels=cal_labels, average='micro')
    r = metrics.recall_score(golden_full, predict_full, labels=cal_labels, average='micro')
    f = metrics.f1_score(golden_full, predict_full, labels=cal_labels, average='micro')
    #p = metrics.precision_score(golden_full, predict_full, labels=["B-Disease", "I-Disease", "E-Disease", "S-Disease"], average='micro')
    #r = metrics.recall_score(golden_full, predict_full, labels=["B-Disease", "I-Disease", "E-Disease", "S-Disease"], average='micro')
    #f = metrics.f1_score(golden_full, predict_full, labels=["B-Disease", "I-Disease", "E-Disease", "S-Disease"], average='micro')
    print("Troken level: p: %.4f, r: %.4f, f: %.4f" % (p, r, f))
