...
class Data:
    ...
    def show_data_summary(self):
        ...
        print("     Gaz   alphabet size: %s" % self.gaz_size)
    ...
    def build_gaz_pretrain_emb(self, skip_first_row=True, separator=" "):
        print("build gaz pretrain emb...")
        self.pretrain_gaz_embedding = np.load(self.gaz_dir)
        self.gaz_size, self.gaz_emb_dim = self.pretrain_gaz_embedding.shape[0], self.pretrain_gaz_embedding.shape[1]
        print("gaz pretain emb size:%d, gaz pretain emb dim:%d" % (self.gaz_size, self.gaz_emb_dim))
    ...
    def generate_instance(self, name):
        ...
        if name == "train":
            ...
            #train_num = int(0.1*len(self.train_texts))
            #self.train_texts, self.train_Ids = self.train_texts[:train_num], self.train_Ids[:train_num]
        elif name == "dev":
